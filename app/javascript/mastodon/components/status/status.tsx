...
> = ({ muted, unfocusable, children, ...handlers }) => {
  ...
  return (
    <Hotkeys
      handlers={{
        // highlander: keyboard shortcuts for reply/favourite/boost/quote/mention
        // were removed fork-wide (see "Remove keyboard shortcuts for hidden UI
        // and unavailable actions"), so they're intentionally omitted here too.
        open: onOpen,
